...
# test_list_path='./Datasets/cretereo_training_list.csv'
# test_list_path='./Datasets/zed_stereo_testing_list.csv'
# test_list_path='./Datasets/middlebury14_Q_stereo_training_list.csv'

# test_list_path='./Datasets/middlebury14_Q_stereo_testing_list.csv'
...
CUDA_VISIBLE_DEVICES=${test_gpus_id} python -u Source/main.py \
                        ...
                        --modelDir ./pre_trained/model_epoch_33.pth \
...
CUDA_VISIBLE_DEVICES=${test_gpus_id} python Source/Tools/evalution_stereo_net.py \
     ...
     --epoch ${confidence_level} \
     --output_path ${result_path} \
     --img_path_format './ResultImg/2%05d_10.png' \
     --mask_img True
