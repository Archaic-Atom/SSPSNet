...
class MyLoss2(Module):
    ...
    def forward(self, input1, input2):
        return MyLoss2Function.apply(input1, input2, self.thresh, self.alpha)
...
class SGA(Module):
    ...
    def forward(self, input, g0, g1, g2, g3):
        return SgaFunction.apply(input, g0, g1, g2, g3)
...
class LGA3D3(Module):
    ...
    def forward(self, input1, input2):
        return Lga3d3Function.apply(input1, input2, self.radius)
...
class LGA3D2(Module):
    ...
    def forward(self, input1, input2):
        return Lga3d2Function.apply(input1, input2, self.radius)
...
class LGA3D(Module):
    ...
    def forward(self, input1, input2):
        return Lga3dFunction.apply(input1, input2, self.radius)
...
class LGA3(Module):
    ...
    def forward(self, input1, input2):
        return Lga3Function.apply(input1, input2, self.radius)
...
class LGA2(Module):
    ...
    def forward(self, input1, input2):
        return Lga2Function.apply(input1, input2, self.radius)
...
class LGA(Module):
    ...
    def forward(self, input1, input2):
        return LgaFunction.apply(input1, input2, self.radius)
