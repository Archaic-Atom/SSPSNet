...
extern "C" int lga_cuda_backward(at::Tensor input, at::Tensor filters,
...
extern "C" int lga_cuda_forward(at::Tensor input, at::Tensor filters,
                                at::Tensor output, const int radius) {
  lga_forward(input, filters, output, radius);
  return 1;
}

extern "C" int lga3d_cuda_backward(at::Tensor input, at::Tensor filters,
                                   at::Tensor gradOutput, at::Tensor gradInput,
                                   at::Tensor gradFilters, const int radius) {
...
extern "C" int lga3d_cuda_forward(at::Tensor input, at::Tensor filters,
                                  at::Tensor output, const int radius) {
  lga3d_forward(input, filters, output, radius);
  return 1;
}

extern "C" int sga_cuda_forward(at::Tensor input, at::Tensor guidance_down,
                                at::Tensor guidance_up,
                                at::Tensor guidance_right,
...
extern "C" int sga_cuda_backward(
    at::Tensor input, at::Tensor guidance_down, at::Tensor guidance_up,
    at::Tensor guidance_right, at::Tensor guidance_left, at::Tensor temp_out,
    at::Tensor mask, at::Tensor max_idx, at::Tensor gradOutput,
    at::Tensor temp_grad, at::Tensor gradInput, at::Tensor grad_down,
    at::Tensor grad_up, at::Tensor grad_right, at::Tensor grad_left) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, GANet) {
  ...
  GANet.def("lga3d_cuda_backward", &lga3d_cuda_backward,
            "lga3d backward (CUDA)");
