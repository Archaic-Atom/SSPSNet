...
class StereoB(nn.Module):
    ...
    def __init__(self, in_channles: int, start_disp: int, disp_num: int,
        ...
        self.projects = nn.ModuleList([
            nn.Conv2d(in_channels=1536, out_channels=out_channel,
    ...
    def _get_dinov2(self) -> nn.Module:
        ...
        feature_extraction = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitg14',
    ...
    def _feature_extraction_module_proc(
        ...
        left_img = self.pretrained.get_intermediate_layers(
            left_img, n = [9, 19, 29, 39], reshape = True, return_class_token = False, norm = False)
        right_img = self.pretrained.get_intermediate_layers(
            right_img, n = [9, 19, 29, 39], reshape = True, return_class_token = False, norm = False)
